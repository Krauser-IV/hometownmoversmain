...
<div class="h-full flex flex-col items-center justify-evenly">
      ...
      <p class="text-center font-medium md:text-xl lg:w-[80%] w-[80%]">{{review.review}}</p>
  ...
  <section class="w-screen pt-5" id="services">
    <h2 class="w-full text-center text-[#f69c22] md:text-5xl text-3xl font-[#21201c]  font-black py-2 mb-4">TURN KEY SERVICES</h2>
    <div class="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 justify-center gap-5 px-5 w-full font-bold">
      ...
      <div class="relative bg-[#21201c] min-w-[23%] h-[70.5vh]">
        ...
        <p class="absolute bottom-4 left-[50%] -translate-x-[50%] w-full text-center  md:text-3xl text-xl font-[#21201c] text-[#f69c22]">STORAGE & PACKING</p>
      </div>
  ...
  <section id='contact'>
    ...
    <div class="text-[#21201c] flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
      <div class="w-1/2 flex flex-col items-center gap-2 md:gap-0">
        <a href="https://web.facebook.com/hometownmovers223/" target="_blank" ><img class="w-[120px]" src="./assets/fb-logo.png"/></a>
